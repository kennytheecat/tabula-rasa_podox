			...
			<header class="archive-header">
				<h1 class="archive-title">
					<?php
						...
						elseif ( is_tag() ) :
							printf( __( 'Archive for %s Tag', 'tabula-rasa' ), '<span>' . single_tag_title( '', false ) . '</span>' );
						...
						elseif ( is_author() ) :
							...
							*/
							the_post();
							printf( __( 'Archive for posts by %s ', 'tabula-rasa' ), '<span class="vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' );
